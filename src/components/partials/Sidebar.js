...
const Sidebar = () => {
    return (
        <div
            className="flex flex-col justify-between overflow-y-auto sticky max-h-(screen-18) mb-10 top-10 w-full">
            <div className="p-4 md:w-full">
                <div
                    className="border-2 border-gray-200 bg-white border-opacity-60 rounded-lg overflow-hidden">
